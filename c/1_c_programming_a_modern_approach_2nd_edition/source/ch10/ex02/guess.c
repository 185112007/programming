/**
* Name: guess.c
* Purpose: Asks to guess a hidden number
...
int main(void)
{
	...
	do
	{
		...
		scanf(" %c", &ch);				/* be careful, there is a space before %c */
		printf("\n");
	} while (ch == 'y' || ch == 'Y');
}
 ...
 *				 user whether each guess is too low, too high,	*
 *				 or correct. When the guess is correct, prints	*
