...
gcc -Wall -E ptr_comparison.c -o main.i		# preprocessing only: will produce the contents of the stdio.h header file joined with the contents of the "main.c" file
