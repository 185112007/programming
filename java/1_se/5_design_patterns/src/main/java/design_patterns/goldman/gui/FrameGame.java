...
import design_patterns.goldman.utils.MessageManager;


@SuppressWarnings("serial")
public class FrameGame extends BaseChildFrame implements ActionListener, KeyListener, MoveResultListener {

    private DrawableMap map; // oyun haritasının kendisini çizebilen nesnesini transfer ediyoruz
    ...
    private void initComponents() {
        ...
        jbtnLeft.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/left.png"))); // NOI18N
        jbtnLeft.setName("jbtnLeft"); // NOI18N
        jbtnLeft.addActionListener(this);

        jbtnUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/up.png"))); // NOI18N
        jbtnUp.setName("jbtnUp"); // NOI18N
        jbtnUp.addActionListener(this);

        jbtnRight.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/right.png"))); // NOI18N
        jbtnRight.setName("jbtnRight"); // NOI18N
        jbtnRight.addActionListener(this);

        jbtnDown.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/down.png"))); // NOI18N
        jbtnDown.setName("jbtnDown"); // NOI18N
        jbtnDown.addActionListener(this);

        jlabelScoreText.setText("Puan sayısı:");
        jlabelScoreText.setName("jlabelScoreText"); // NOI18N

        jlabelTurnsLeftText.setText("Kalan hamle:");
        jlabelTurnsLeftText.setToolTipText("");
        jlabelTurnsLeftText.setName("jlabelTurnsLeftText"); // NOI18N

        jbtnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/save.png"))); // NOI18N
        jbtnSave.setText("Kaydet");
        jbtnSave.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jbtnSave.setName("jbtnUp"); // NOI18N
        jbtnSave.addActionListener(this);

        jbtnExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/exit.png"))); // NOI18N
        jbtnExit.setText("Oyundan çık");
        ...
        jMenuItem1.setText("Oyunu kaydet");
        jmenuFile.add(jMenuItem1);

        jMenuItem2.setText("Oyunda çık");
        jMenuItem2.setActionCommand("Çıkış");
    ...
    private static final String DIE_MESSAGE="Kaybettin!";
    private static final String WIN_MESSAGE="Sen kazandın! Puan sayısı:";
