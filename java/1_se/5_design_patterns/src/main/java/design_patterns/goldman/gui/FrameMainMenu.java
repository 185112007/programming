...
import design_patterns.goldman.interfaces.gamemap.collections.MapCollection;
import design_patterns.goldman.objects.gui.maps.JTableGameMap;
...
public class FrameMainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtnNewGame.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/new.png"))); // NOI18N
        jbtnNewGame.setText("Yeni oyun");
        jbtnNewGame.setToolTipText("Yeni oyun oluştur");
        ...
        jbtnLoadGame.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/load.png"))); // NOI18N
        jbtnLoadGame.setText("Oyun yukle");
        jbtnLoadGame.setToolTipText("Kayıt edilen oyunu yukle ");
        ...
        jbtnStatistics.setIcon(new javax.swing.ImageIcon(getClass().getResource("/design_patterns/goldman/images/stat.png"))); // NOI18N
        jbtnStatistics.setText("Istatistik");
        jbtnStatistics.setToolTipText("Oyuncu İstatistiklerini Göster");
        ...
        jbtnExit.setText("Çıkış");
        jbtnExit.setToolTipText("Oyundan çık");
